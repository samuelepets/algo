"""Technical indicators for mr01_bollinger_band.
...
def build_bb_cache(
    ...
    Returns ``(sma_matrix, std_matrix, period_index)`` where each matrix row
    corresponds to one period and ``period_index[p]`` gives the row.
    """
