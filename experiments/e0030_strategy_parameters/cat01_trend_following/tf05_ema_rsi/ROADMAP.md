# Roadmap — TF-05 EMA + RSI Filter

## Phase 0 — Rust project setup
- [ ] `cargo init --name tf05_ema_rsi` in this directory.
...
## Phase 3 — Indicator(s): EMA fast/slow crossover + RSI threshold gate
- [ ] Implement each indicator as a pure function over `&[Bar]` or `&[f64]`.
- [ ] Unit test against known reference values.

## Phase 4 — Backtest engine
- [ ] Signal logic specific to TF-05 EMA + RSI Filter.
