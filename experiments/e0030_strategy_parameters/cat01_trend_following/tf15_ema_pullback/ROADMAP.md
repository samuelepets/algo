# Roadmap — TF-15 EMA Pullback

## Phase 0 — Rust project setup
- [ ] `cargo init --name tf15_ema_pullback` in this directory.
...
## Phase 3 — Indicator(s): EMA(fast) as dynamic support; rejection candle entry pattern
- [ ] Implement each indicator as a pure function over `&[Bar]` or `&[f64]`.
- [ ] Unit test against known reference values.

## Phase 4 — Backtest engine
- [ ] Signal logic specific to TF-15 EMA Pullback.
