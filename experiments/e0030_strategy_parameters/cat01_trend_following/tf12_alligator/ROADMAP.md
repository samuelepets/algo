# Roadmap — TF-12 Williams Alligator

## Phase 0 — Rust project setup
- [ ] `cargo init --name tf12_alligator` in this directory.
...
## Phase 3 — Indicator(s): SMMA(Jaw/Teeth/Lips) with Fibonacci periods and forward shifts
- [ ] Implement each indicator as a pure function over `&[Bar]` or `&[f64]`.
- [ ] Unit test against known reference values.

## Phase 4 — Backtest engine
- [ ] Signal logic specific to TF-12 Williams Alligator.
