# Roadmap — TF-09 VWAP Trend Bias

## Phase 0 — Rust project setup
- [ ] `cargo init --name tf09_vwap_trend` in this directory.
...
## Phase 3 — Indicator(s): Session VWAP as dynamic support/resistance
- [ ] Implement each indicator as a pure function over `&[Bar]` or `&[f64]`.
- [ ] Unit test against known reference values.

## Phase 4 — Backtest engine
- [ ] Signal logic specific to TF-09 VWAP Trend Bias.
