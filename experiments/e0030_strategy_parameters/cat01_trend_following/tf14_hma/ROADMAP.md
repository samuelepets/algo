# Roadmap — TF-14 Hull MA (HMA)

## Phase 0 — Rust project setup
- [ ] `cargo init --name tf14_hma` in this directory.
...
## Phase 3 — Indicator(s): WMA-based reduced-lag moving average; slope and crossover variants
- [ ] Implement each indicator as a pure function over `&[Bar]` or `&[f64]`.
- [ ] Unit test against known reference values.

## Phase 4 — Backtest engine
- [ ] Signal logic specific to TF-14 Hull MA (HMA).
