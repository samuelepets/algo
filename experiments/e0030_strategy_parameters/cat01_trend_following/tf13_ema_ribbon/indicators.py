"""Technical indicators for tf13_ema_ribbon.

Pure Numba kernels: EMA and ATR. The ribbon is a set of geometrically-spaced EMAs
assembled in the driver from a shared EMA cache.
"""
