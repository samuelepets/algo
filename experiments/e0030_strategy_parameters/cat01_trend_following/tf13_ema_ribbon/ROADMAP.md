# Roadmap — TF-13 EMA Ribbon

## Phase 0 — Rust project setup
- [ ] `cargo init --name tf13_ema_ribbon` in this directory.
...
## Phase 3 — Indicator(s): N EMAs with geometric spacing; alignment score and expansion measure
- [ ] Implement each indicator as a pure function over `&[Bar]` or `&[f64]`.
- [ ] Unit test against known reference values.

## Phase 4 — Backtest engine
- [ ] Signal logic specific to TF-13 EMA Ribbon.
