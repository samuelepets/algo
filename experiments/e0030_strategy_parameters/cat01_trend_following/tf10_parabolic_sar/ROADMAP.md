# Roadmap — TF-10 Parabolic SAR

## Phase 0 — Rust project setup
- [ ] `cargo init --name tf10_parabolic_sar` in this directory.
...
## Phase 3 — Indicator(s): SAR dot flip as stop-and-reverse signal
- [ ] Implement each indicator as a pure function over `&[Bar]` or `&[f64]`.
- [ ] Unit test against known reference values.

## Phase 4 — Backtest engine
- [ ] Signal logic specific to TF-10 Parabolic SAR.
