"""Data access layer for tf20_elder_impulse.

Loads 1-minute EURUSD OHLCV bars from the repo data corpus and
provides a Numba-friendly resampling kernel.
"""
...
# experiments/.../tf20_elder_impulse/data.py -> repo root is four levels up.
