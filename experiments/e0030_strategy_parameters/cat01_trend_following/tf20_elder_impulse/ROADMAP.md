# Roadmap — TF-20 Elder Impulse

## Phase 0 — Rust project setup
- [ ] `cargo init --name tf20_elder_impulse` in this directory.
...
## Phase 3 — Indicator(s): EMA slope + MACD histogram direction → bar color code (Green/Red/Neutral)
- [ ] Implement each indicator as a pure function over `&[Bar]` or `&[f64]`.
- [ ] Unit test against known reference values.

## Phase 4 — Backtest engine
- [ ] Signal logic specific to TF-20 Elder Impulse.
