# Roadmap — TF-18 N-Bar Breakout

## Phase 0 — Rust project setup
- [ ] `cargo init --name tf18_nbar_breakout` in this directory.
...
## Phase 3 — Indicator(s): N-period high/low breakout; ATR stop; optional volume filter
- [ ] Implement each indicator as a pure function over `&[Bar]` or `&[f64]`.
- [ ] Unit test against known reference values.

## Phase 4 — Backtest engine
- [ ] Signal logic specific to TF-18 N-Bar Breakout.
