# Roadmap — TF-17 Donchian Channel

## Phase 0 — Rust project setup
- [ ] `cargo init --name tf17_donchian` in this directory.
...
## Phase 2 — Resampling
- [ ] Implement `resample(bars, minutes)` → aggregate 1-min to 5-min, 15-min, 1-h.

## Phase 3 — Indicator(s): N-bar highest high / lowest low entry and exit channels
- [ ] Implement each indicator as a pure function over `&[Bar]` or `&[f64]`.
- [ ] Unit test against known reference values.

## Phase 4 — Backtest engine
- [ ] Signal logic specific to TF-17 Donchian Channel.
