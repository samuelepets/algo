# Roadmap — TF-16 LinReg Channel

## Phase 0 — Rust project setup
- [ ] `cargo init --name tf16_linreg_channel` in this directory.
...
## Phase 3 — Indicator(s): Rolling OLS regression line + residual standard deviation bands
- [ ] Implement each indicator as a pure function over `&[Bar]` or `&[f64]`.
- [ ] Unit test against known reference values.

## Phase 4 — Backtest engine
- [ ] Signal logic specific to TF-16 LinReg Channel.
